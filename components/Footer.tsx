 ...
 const linkSections = [
        {
            title: "MENU",
            links: [
                { text: "Shawarma", path: '/', icon: null },
                { text: "Burgers", path: '/', icon: null },
                { text: "Drinks", path: '/', icon: null },
                { text: "Desserts", path: '/', icon: null },
            ]
        },
        {
            title: "WEBSITE",
            links: [
                ...
                { text: "Order Now", path: '/order', icon: null },
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+961-71-00000", path: '/', icon: PhoneIcon },
                { text: "contact@alzal.com", path: '/', icon: MailIcon },
    ...
    className="h-[60px] w-[220px] object-cover"
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">
                            Welcome to AL ZAL STREET FOOD — the heart of authentic flavors. 
                            From shawarma and burgers to fresh juices and desserts, 
                            we serve the real taste of the street with quality and passion.
                        </p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © AL ZAL STREET FOOD — All Rights Reserved.
                </p>
            </div>
        </footer>
    );
